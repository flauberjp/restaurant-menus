...
# Menu for The CRUDdy Crab
restaurant2 = Restaurant(name="The CRUDdy Crab")
...
menuItem4 = MenuItem(name="Caesar Salad", 
...
menuItem5 = MenuItem(name="Iced Tea", 
...
menuItem6 = MenuItem(name="Spinach Dip", 
...
# Menu for Blue Burgers
restaurant3 = Restaurant(name="Blue Burgers")

session.add(restaurant3)
session.commit()

# Menu for Taco Hut
restaurant4 = Restaurant(name="Taco Hut")
